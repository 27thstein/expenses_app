                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text('${ExStrings.hello} ${state.userName},'),
                              Text(
                          ...
                          SizedBox(
                            width: ExDeviceUtils.getScreenWidth(context) * 0.2,
                          ),
                          SvgPicture.asset(
                              height: 24, width: 24, ExImages.bellIcon),
                        ],
                      ),
                    ),
                  ),
                        ...
                        Positioned(
                          ...
                          child: Text(
                            ...
                            style: ExTextTheme.lightTextTheme.bodyMedium!
                                .copyWith(
                                    color: Colors.white, letterSpacing: 0.28),
                          ),
                        ),
                      ],
                    ),
